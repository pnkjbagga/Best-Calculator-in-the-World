...
% rbh3 = uicontrol(control_buttons_2,'Style','radiobutton','String','Oct',...
%                 'Value',1,'Position',[5 160 90 65] , 'CallBack',@s51);
% rbh4 = uicontrol(control_buttons_2,'Style','radiobutton','String','Bin',...
%                 'Value',1,'Position',[5 120 90 65] , 'CallBack',@s52);
% rbh5 = uicontrol(control_buttons_2,'Style','radiobutton','String','Degrees',...
